...
export const cards = [
  ...
  { id: 1, name: 'Geezard', level: 1, cost: 1, stats: [1, 4, 1, 5], element: ELEMENTS.NONE },
  { id: 2, name: 'Funguar', level: 1, cost: 1, stats: [5, 1, 1, 3], element: ELEMENTS.NONE },
  { id: 3, name: 'Bite Bug', level: 1, cost: 1, stats: [1, 3, 3, 5], element: ELEMENTS.NONE },
  { id: 4, name: 'Red Bat', level: 1, cost: 1, stats: [6, 1, 1, 2], element: ELEMENTS.NONE },
  { id: 5, name: 'Blobra', level: 1, cost: 1, stats: [2, 3, 1, 5], element: ELEMENTS.NONE },
  { id: 6, name: 'Gayla', level: 1, cost: 1, stats: [2, 1, 4, 4], element: ELEMENTS.THUNDER },
  ...
  { id: 9, name: 'Blood Soul', level: 1, cost: 1, stats: [2, 1, 6, 1], element: ELEMENTS.NONE },
  ...
  { id: 12, name: 'Grat', level: 2, cost: 2, stats: [7, 1, 3, 1], element: ELEMENTS.NONE },
  { id: 13, name: 'Buel', level: 2, cost: 2, stats: [6, 2, 2, 3], element: ELEMENTS.NONE },
  { id: 14, name: 'Mesmerize', level: 2, cost: 2, stats: [5, 3, 3, 4], element: ELEMENTS.NONE },
  { id: 15, name: 'Glacial Eye', level: 2, cost: 2, stats: [6, 1, 4, 3], element: ELEMENTS.ICE },
  { id: 16, name: 'Belhelmel', level: 2, cost: 2, stats: [3, 3, 4, 5], element: ELEMENTS.NONE },
  { id: 17, name: 'Thrustaevis', level: 2, cost: 2, stats: [5, 3, 2, 5], element: ELEMENTS.WIND },
  { id: 18, name: 'Anacondaur', level: 2, cost: 2, stats: [5, 1, 3, 5], element: ELEMENTS.POISON },
  { id: 19, name: 'Creeps', level: 2, cost: 2, stats: [5, 2, 5, 2], element: ELEMENTS.THUNDER },
  { id: 20, name: 'Grendel', level: 2, cost: 2, stats: [4, 4, 5, 2], element: ELEMENTS.THUNDER },

  // Level 3 Monster Cards - Cost 3
  { id: 21, name: 'Forbidden', level: 3, cost: 3, stats: [6, 6, 3, 2], element: ELEMENTS.NONE },
  ...
  { id: 27, name: 'SAM08G', level: 3, cost: 3, stats: [5, 6, 2, 4], element: ELEMENTS.FIRE },
  { id: 28, name: 'Death Claw', level: 3, cost: 3, stats: [4, 4, 7, 2], element: ELEMENTS.FIRE },
  { id: 29, name: 'Cactuar', level: 3, cost: 3, stats: [6, 2, 6, 3], element: ELEMENTS.NONE, ability: 'center_boost' },
  { id: 30, name: 'Tonberry', level: 3, cost: 3, stats: [3, 6, 4, 4], element: ELEMENTS.NONE, ability: 'giant_slayer' },

  // Level 4 Monster Cards - Cost 4
  { id: 31, name: 'T-Rexaur', level: 4, cost: 4, stats: [4, 6, 2, 7], element: ELEMENTS.NONE },
  { id: 32, name: 'Bomb', level: 4, cost: 4, stats: [2, 7, 6, 3], element: ELEMENTS.FIRE },
  ...
  { id: 36, name: 'Adamantoise', level: 4, cost: 4, stats: [4, 5, 5, 6], element: ELEMENTS.EARTH, ability: 'fortress' },

  // Level 5 Monster Cards - Cost 5
  { id: 37, name: 'Iron Giant', level: 5, cost: 5, stats: [6, 5, 5, 6], element: ELEMENTS.NONE, ability: 'giant_slayer' },
  ...
  { id: 40, name: 'PuPu', level: 5, cost: 5, stats: [3, 10, 2, 1], element: ELEMENTS.NONE },
